...
export default {
    ...
    methods: {
        ...
        getAllProject() {
            axios.get(`http://127.0.0.1:3031/api/project`)
                .then(res => {
        ...
        getAllDevice() {
            axios.get(`http://127.0.0.1:3031/api/device`)
                .then(res => {
        ...
        getAllSoftware() {
            axios.get(`http://127.0.0.1:3031/api/software`)
                .then(res => {
        ...
        getAllDeviceNotInProject(id) {
            axios.get(`http://127.0.0.1:3031/api/devicenotinproject/${id}`)
                .then(res => {
                this.allDevice = res.data;
        ...
        getAllSoftwareNotInProject(id) {
            axios.get(`http://127.0.0.1:3031/api/softwarenotinproject/${id}`)
                .then(res => {
                this.allSoftware = res.data;
            }).catch(e => {
                console.log(e);
        ...
        getAllDeviceByProjectId(id) {
            axios.get(`http://127.0.0.1:3031/api/devicebyproject/${id}`)
                .then(res => {
        ...
        getAllSoftwareByProjectId(id) {
            axios.get(`http://127.0.0.1:3031/api/softwarebyproject/${id}`)
                .then(res => {
        ...
        addNewProject() {
            ...
            axios.post("http://127.0.0.1:3031/api/project", d)
                .then(res => {
            ...
            if(cp == null){
              alert("Hãy chọn project!!!");
                ...
                for (let d in this.selectedDevice) {
                    ...
                    radio.checked = false;
                    await axios.post("http://127.0.0.1:3031/api/addDevicetoProject", dt)
                        .catch(e => {
                        console.log(e);
                    });
            ...
            if(cp == null){
              alert("Hãy chọn project!!!");
                ...
                for (let s in this.selectedSoftware) {
                    ...
                    radio.checked = false;
                    await axios.post("http://127.0.0.1:3031/api/addSoftwaretoProject", dt)
                        .catch(e => {
                        console.log(e);
                    });
        ...
        removeDeviceFromProject(device, id_project) {
            ...
            axios.delete(`http://127.0.0.1:3031/api/removedevicefromproject/${id_device}/${id_project}`)
                .then(res => {
        ...
        removeSoftwareFromProject(software, id_project) {
            ...
            axios.delete(`http://127.0.0.1:3031/api/removesoftwarefromproject/${id_software}/${id_project}`)
                .then(res => {
