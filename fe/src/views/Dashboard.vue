  ...
  export default {
    ...
    methods: {
      getAllProject() {
        ...
        updateDevice(id) {
            axios.put(`http://127.0.0.1:3031/api/device/${id}`)
                .then(res => {
        ...
        updateSoftware(id) {
            axios.put(`http://127.0.0.1:3031/api/software/${id}`)
                .then(res => {
                console.log(res.data);
            }).catch(e => {
                console.log(e);
        ...
        seeAllHistory(id) {
          axios.get(`http://127.0.0.1:3031/api/allHistoryofDevice/${id}`)
          .then(res => {
        ...
        addHistory(id){
          ...
          axios.post("http://127.0.0.1:3031/api/addHistory",data)
          .then(res => {
            this.newHistory = '';
            alert(res.data);
          }).catch(e =>{
